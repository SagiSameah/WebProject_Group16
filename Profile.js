document.addEventListener('DOMContentLoaded', () => {
    ...
    const genres = ["פרוזה","פילוסופיה","פנטזיה", "מתח", "רומנטיקה", "מדע בדיוני", "ביוגרפיה"];
    const authors = ["ש\"י עגנון", "דוד גרוסמן", "צרויה שלו", "עמוס עוז", "אלונה קמחי","דניאל נוס","שגיא שמח"];
